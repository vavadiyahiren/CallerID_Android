...
import com.callerid.callmanager.databinding.RecentCallHistoryItemBinding;
...
public class CallLogHistoryAdapter extends RecyclerView.Adapter<CallLogHistoryAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        RecentCallHistoryItemBinding binding = RecentCallHistoryItemBinding.inflate(
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.binding.txtDate.setText(model.formattedDate);
        holder.binding.txtTime.setText(model.formattedTime);
        holder.binding.txtCallType.setText(model.callTypeText);
        holder.binding.imgCallType.setImageResource(model.callTypeIcon);

        if (model.getType() == CallLog.Calls.MISSED_TYPE) {
            holder.binding.txtCallTime.setVisibility(android.view.View.GONE);
            holder.binding.viewLast.setVisibility(android.view.View.GONE);
        } else {
            holder.binding.txtCallTime.setVisibility(android.view.View.VISIBLE);
            holder.binding.viewLast.setVisibility(android.view.View.VISIBLE);
            holder.binding.txtCallTime.setText(model.formattedDuration);
        }
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        RecentCallHistoryItemBinding binding;

        public ViewHolder(@NonNull RecentCallHistoryItemBinding binding) {
